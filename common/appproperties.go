...
import (
	...
	"github.com/scrib-dev/unioffice/schema/soo/ofc/extended_properties"
)
...
func NewAppProperties() AppProperties {
	...
	p.SetApplication("github.com/scrib-dev/unioffice")
	p.SetDocSecurity(0)
...
// For gooxml created documents, it defaults to github.com/scrib-dev/unioffice
